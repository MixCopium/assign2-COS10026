  ...
  <!-- Less crucial contact info: Address in general -->
          ...
          <div class="part product_option">
            ...
            <select id="bookop" class="book" name="book">
              ...
              <option  value="Harry Potter and the Philosophers Stone - J.K Rowling" <?php echo (($_POST["book_order"] == "Harry Potter and the Philosophers Stone") ? "selected" : "") ?> >Harry Potter and the Philosopher's Stone - J.K Rowling</option>
